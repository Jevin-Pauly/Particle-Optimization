...
float Matrix::Determinant() 
{
	...
	// tb = (kq - mo)
	//float tb = 0.0f/*(m9 * m15) - (m11 * m13)*/;
	// tc = (kp - lo)
	float tc = (m9 * m14) - (m10 * m13);
	// td = (jq - mn)
	//float td = 0.0f/*(m8 * m15) - (m11 * m12)*/;
	// te = (jo - kn)
	//float te = 0.0f/*(m8 * m13) - (m9 *  m12)*/;
	// tf = (jp - ln)
	//float tf = 0.0f/*(m8 * m14) - (m10 * m12)*/;
	
	/*return ((m0 * ((m5 * ta) - (m6 * 0.0f) + (m7 * tc)))
			- (m1 * ((m4 * ta) - (m6 * 0.0f) + (m7 * 0.0f)))
			+ (m2 * ((m4 * 0.0f) - (m5 * 0.0f) + (m7 * 0.0f)))
			- (m3 * ((m4 * tc) - (m5 * 0.0f) + (m6 * 0.0f))));*/
	return ((m0 * ((m5 * ta) - (0.0f) + (m7 * tc)))
		- (m1 * (m4 * ta))
		- (m3 * (m4 * tc)));
