...
public:
	...
	//2) and 3) to prevent certain methods of Vect2D from being called from GameVect we don't add those here
...
private:
	...
	// 1) since Vect2D inheritance is private x and y are in the private section by default
};
