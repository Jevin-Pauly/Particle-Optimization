...
bool OpenGLDevice::privInitWindow()
{
	...
	wc.lpszClassName = "CSC 461: Fall 2023";//title.getCString();					// Set The Class Name
	...
	hWnd = CreateWindowEx(dwExStyle,				// Extended Style For The Window
		"CSC 461: Fall 2023",//title.getCString(),				// Class Name
		"CSC 461: Fall 2023",//title.getCString(),					// Window Title
...
bool OpenGLDevice::privKillWindow()
{
	...
	if(!UnregisterClass("CSC 461: Fall 2023", hInstance))
