...
void Students_PointerWalk()
{
	...
	//   what is value *(r)?
	valint = *(r); 
	QuestionAnswer(12, valint); 
	// Q13:
	//   what is value *(r + 3)?
	valint = *(r + 3);
	QuestionAnswer(13, valint);
	...
	//   what is value *(s + 3)?
	vals = *(s + 3); 
	QuestionAnswer(19, vals); 
	// Q20:
	//   what is value *(s)?
	vals = *(s);
	QuestionAnswer(20, vals);
