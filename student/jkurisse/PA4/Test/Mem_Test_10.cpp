...
TEST(Mem10_Allocate_3_100_middle_up_free, TestConfig::Flag::ALL)
{
...

	{
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0x4290);
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0x429c);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x8558);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0x4290);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x8558);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0x852C);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0xc800);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0xc7d4);
