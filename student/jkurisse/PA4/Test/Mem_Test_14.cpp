...
TEST(Mem14_combo_1, TestConfig::Flag::ALL)
{
	...
	// ----  GENERAL CHECK ------------------------------------------------------
	{
		...
		blkStart = hdrEnd;
		blkEnd = blkStart + GET_ALLOC_SIZE(used->mData);

		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x22c);
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0x200);
		...
		// Above free
		CHECK(IS_ABOVE_USED(used->mData));
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0x300);
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0x400);
		...
		// Should be USED
		CHECK(IS_FREE(free->mData));

		// Above free
		CHECK(IS_ABOVE_USED(free->mData));
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0xb380);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x22c);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0x200);
		...
		// Above free
		CHECK(IS_ABOVE_FREE(used->mData));
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x744);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0x300);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x1168);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0x400);
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0x180);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0xc800);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0xb1f4);
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0xb100);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0xc800);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0xe8);
		...
		CHECK_EQUAL(GET_ALLOC_SIZE(used->mData), 0x220);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x744);
		CHECK_EQUAL(GET_ALLOC_SIZE(free->mData), 0xd4);
